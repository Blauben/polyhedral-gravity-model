...
namespace polyhedralGravity {
    std::unique_ptr<TreeNode> TreeNodeFactory::treeNodeFactory(const SplitParam &splitParam, size_t currentRecursionDepth, const std::shared_ptr<PlaneSelectionAlgorithm> &planeAlgorithm) {
        ...
        auto [plane, planeCost, triangleIndexLists] = planeAlgorithm->findPlane(splitParam);
